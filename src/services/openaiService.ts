...
3) Зміст: що означає саме ця карта і як це б'є саме в це питання. 2–4 речення, зв'язно, з матами(сука, бля, пиздець, заєбало, хуйня й подібними).
...
Тон:
- Втома: «знову ти», «скільки можна», «я вже не вивожу», «не зайобуй», «оййй бля».
